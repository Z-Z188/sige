...
from ldm.modules.diffusionmodules.sige_openaimodel import SIGEUNetModel
...
class DDIMSampler(object):
        ...
        for i, step in enumerate(iterator):
            ...
            if mask is not None:
                ...
                if isinstance(self.model.model.diffusion_model, SIGEUNetModel):
                    ...
                    self.model.model.diffusion_model.set_masks(conv_masks)
    ...
    def sige_img2img_decode(
        ...
        iterator = tqdm(time_range, desc="Decoding image", total=total_steps)
        x_dec_init = x_latent_init
        x_dec_edited = x_latent_edited
        assert isinstance(self.model.model.diffusion_model, SIGEUNetModel)
        ...
        return x_dec_init, x_dec_edited
